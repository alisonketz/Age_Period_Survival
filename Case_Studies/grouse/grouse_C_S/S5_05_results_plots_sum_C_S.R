...
traceplot(out[, "b_period_yr1[1]"], ylab = "b_period_yr1[1]")
traceplot(out[, "b_period_yr1[3]"], ylab = "b_period_yr1[3]")
traceplot(out[, "b_period_yr1[5]"], ylab = "b_period_yr1[5]")

traceplot(out[, "b_period_yr2[1]"], ylab = "b_period_yr2[1]")
traceplot(out[, "b_period_yr2[3]"], ylab = "b_period_yr2[3]")
traceplot(out[, "b_period_yr2[5]"], ylab = "b_period_yr2[5]")

traceplot(out[, "b_period_yr3[1]"], ylab = "b_period_yr3[1]")
traceplot(out[, "b_period_yr3[3]"], ylab = "b_period_yr3[3]")
traceplot(out[, "b_period_yr3[5]"], ylab = "b_period_yr3[5]")
...
p_s_ageperiod_yr2 <- ggplot(data = out_s_ageperiod_yr2,
  ...
  geom_line(aes(x = Weeks,y=survival_yr2),
            ...
            size = 2) +
  ylim(0, 1) +
  ggtitle("Survival - Period Year 2") +
...
p_s_ageperiod_yr3 <- ggplot(data = out_s_ageperiod_yr3,
  ...
  geom_line(aes(x = Weeks,y=survival_yr3),
            ...
            size = 2) +
  ylim(0, 1) +
  ggtitle("Survival - Period Year 3") +
  xlab("ageperiod (Days)") + ylab("Survival Probability")+
  theme_bw()
