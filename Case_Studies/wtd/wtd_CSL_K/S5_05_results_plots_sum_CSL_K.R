...
age_effect_cgam_plot=ggplot(data =out_age_effect,aes(x = weeks))+
...
age_effect_spline_plot=ggplot(data =out_age_effect,aes(x = weeks))+
  geom_line(aes(x = weeks,y=age_effect_mean),size=1)+
  geom_ribbon(aes(ymin = age_effect_lower,
                  ymax = age_effect_upper),
              alpha = .2,
...
#######################################
###
### Log hazard - Age Effects Combined
###
#######################################
...
age_effect_combo_plot <- ggplot(data = out_age_effect,
                                aes(x = weeks)) +
  geom_line(aes(x = weeks,
                y = age_effect_mean),
            size = 1) +
  geom_ribbon(aes(ymin = age_effect_lower,
              ...
              alpha = .2,
              linetype = 0) +
  ggtitle("Age Effect Posterior Combined") +
  xlab("Age") + ylab("Effect Size") +
  theme_bw() +
  scale_color_brewer("Year",palette = 'Set1') +
  scale_fill_brewer("Year",palette = 'Set1') +
...
age_effect_combo_plot

ggsave("age_effect_combo.pdf",age_effect_combo_plot)

##################################
###
### Survival - Period effects
###
##################################
