#######################################################
###
### Preliminary constants for CAR model
###
#######################################################

#######################################################
###
### Period effects constants
###
#######################################################
...
temp <- as.matrix(bandSparse(n = nT_period,
                           k = c(1),
                           symmetric = TRUE))
...
######################################################################################################################3
###
### Parameters for CAR model for Time
###
######################################################################################################################3
...
temp <- as.matrix(bandSparse(n = nT_age,
                           k = c(1),
                           symmetric = TRUE))
